...
export default function dubaidevelopmentcompany() {
  ...
  const storyLine = {
    ...
    subPara: <>Here are the <Link href="/mobile-application-development-services" className="fw600 text-black">mobile app development services</Link> that BitsWits offers in Miami:</>,
