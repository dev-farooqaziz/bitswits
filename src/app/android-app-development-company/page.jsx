      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "potentialAction": {
              "@type": "SearchAction",
              "target": "https://www.bitswits.co/android-app-development-company?search_term_string={search_term_string}", // Updated target URL
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@id": "https://www.bitswits.co/android-app-development-company#business",
            "url": "https://www.bitswits.co/android-app-development-company",
            "telephone": "+1 833 500-6007",
            "address": {
              "@type": "PostalAddress",
