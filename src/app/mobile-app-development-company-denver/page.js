...
export default function dubaidevelopmentcompany() {
  ...
  const WhoWeAre = {
    ...
    desc: <>The foundation of BitsWits's success is our dedication to providing Denver with the best <Link href="/mobile-application-development-services" className="fw600 text-black">mobile app development services</Link> to win our clients' steadfast <br className="d-xl-block d-none" /> faith. Our portfolio includes numerous carefully planned and created mobile applications.</>,
