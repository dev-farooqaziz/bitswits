...
const Scripts = () => {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            ...
            analyticScript.src = "https://www.googletagmanager.com/gtag/js?id=G-T8JYHWL639";
    ...
    return (
        <>
            <Head>
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(indexingapi) }} />
            </Head>
        </>
    );
}
