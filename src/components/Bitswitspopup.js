    ...
    <>
      ...
      <div className={styles[props.formsaspire]}>
        ...
        <form className={styles.formalign} onSubmit={handleSubmit}>
          ...
          <textarea className={styles.formfree} required name="comment" rows="2" placeholder="Type Your Message Here"></textarea>
          <button className={`bitsForm ${styles.freebtn}`} type="submit" disabled={isDisabled}>{score}</button>
        </form>
